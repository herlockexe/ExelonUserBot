...
LOGS.info("Herlock çalışıyor! Herhangi bir sohbete .alive yazarak Test edin.")
LOGS.info(
    "Yardıma ihtiyacınız varsa, Destek grubumuza gelin t.me/HerlocSupport\n"
    "Herlock Sürümü 1.0.0")
